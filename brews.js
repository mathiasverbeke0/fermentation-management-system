const brewData = [
    ...
    },
    {
        ...
        "rackingDates": null,
        "bottlingDate": null,
        "recipe": "To make a 4-liter batch of plum wine, begin by juicing approximately 3 liters worth of of handpicked plums, including skins. Filter the juice through a clean cloth to remove excess pulp. In a sanitized vessel, dissolve a total of 770g of granulated sugar in warm water and add it to the juice (initially 570g of sugar was added, then after measuring the specific gravity, an additional 200g was added to reach an OG of 1.092). Top up with water to reach a total volume of 4 liters. Add 4g of Nutrivit yeast nutrient and pitch 10g of Mangrove Jack’s O5 mead yeast. Seal with an airlock.",
        "fermentationNotes": "Ferment at 18–24°C in a dark, stable environment. Yeast was pitched directly to start fermentation. Monitor activity closely during the first few days. Stirring not required unless signs of stagnation appear. Allow fermentation to proceed until bubbling slows significantly. Fermentation began approximately 4 hours after pitching the yeast.",
    ...
    },
    {
        ...
        "bottlingNotes": null,
        "sensoryNotes": null,
        "experimentalNotes": "First time using juice as the sole liquid base instead of traditional water. Monitor closely for any unexpected fermentation behavior caused by preservatives or residual compounds."
    },
    {
        "id": 11,
